...
# TODO: need to build in support for multiple payments, at moment, just single payment details sent here (certain nvp request methods default to zero if no value supplied).
class PayPal( object ):
	
	def __init__( self, profile, sandbox=True, apiSignature=True ):
